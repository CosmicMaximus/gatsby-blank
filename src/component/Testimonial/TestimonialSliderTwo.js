        ...
        <Slider {...settings} className="testimonial_slider_Two">
          <div className="item">
            <p>
              ...
              guessing – just asked and answered quickly in order to make their
              purchasing decisions easier!
            </p>
            <div className="media">
              <div className="author_img">
                <img src={require("../../images/slider2.png")} alt="" />
              </div>
          ...
          <div className="item">
            ...
            <div className="media">
              <div className="author_img">
                <img src={require("../../images/our-coaches-2.jpg")} alt="" />
              </div>
              <div className="media-body">
                <h6>Michael Bean</h6>
          ...
          <div className="item">
            ...
            <div className="media">
              <div className="author_img">
                <img src={require("../../images/our-coaches-7.jpg")} alt="" />
              </div>
              <div className="media-body">
                <h6>Edward Evans</h6>
                <span>Envato Customer</span>
