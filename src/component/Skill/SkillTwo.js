          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="skill_content_two">
                ...
                />
                <p>
                  Horse play chinwag bog-standard loo cup of char fanny around
                  tinkety tonk old fruit bog me old mucker is bits and bobs,
                  mush cheeky bugger nancy boy.!
                </p>
                <div className="row">
                  <CounterItem
                    col="col-md-6 s_item"
                    CText="200"
                    pdescription="Design Process"
                  />
                  <CounterItem
                    col="col-md-6 s_item"
                    CText="120"
                    pdescription="UX Thinking"
                  />
                  <CounterItem
                    col="col-md-6 s_item"
                    CText="4"
                    pdescription="Prototype"
                  />
                  <CounterItem
                    col="col-md-6 s_item"
                    CText="10"
                    pdescription="Support"
                  />
                </div>
              </div>
            </div>
